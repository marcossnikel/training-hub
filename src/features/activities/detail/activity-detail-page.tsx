...
import { ActivityChart } from "@/features/activities/chart/activity-chart";
...
import { listFastestBestEfforts } from "@/features/activities/server/evidence-store";
...
import { ComparePriorActivityEntry } from "@/app/activity/[id]/compare-prior-activity-entry";

export async function generateActivityMetadata(id: string) {
...
export async function ActivityDetailPage({ id }: { id: string }) {
  const owner = await requireCurrentUser();
